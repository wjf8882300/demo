...
public class DateUtils {
	...
	public final static String FORMAT_STR_DATE_TIME = "yyyy-MM-dd HH:mm:ss";
	public final static String FORMAT_STR_DATE_TIME_SSS = "yyyy-MM-dd HH:mm:ss.SSS";
	public final static String FORMAT_STR_DATE = "yyyy-MM-dd";
	public final static String FORMAT_STR_TIME = "HH:mm:ss";
	 ...
	 * @return
	 */
	public static Date getAfterSeconds(Date date, Integer seconds) {
	 ...
	 * @return
	 */
	public static Date getAfterHour(Date date, Integer hour) {
	 ...
	 * @return
	 */
	public static Date getAfterYear(Date date, int par) {
		return org.apache.commons.lang3.time.DateUtils.truncate(org.apache.commons.lang3.time.DateUtils.addYears(date, par), Calendar.DAY_OF_MONTH);
	}
	...
	public static Date getFirstDateOfMonth(Date dt) {
		return org.apache.commons.lang3.time.DateUtils.truncate(dt, Calendar.MONTH);
	}
	...
	public static String getFirstDay(Date dt,String formatStr) {
		return formatDate(getFirstDateOfMonth(dt), formatStr);
	}
	...
	public static Date getLastDateOfMonth(Date dt) {
		...
		return org.apache.commons.lang3.time.DateUtils.truncate(ca.getTime(), Calendar.DAY_OF_MONTH);
	}
	...
	public static String getLastDay(Date dt,String formatStr) {
		Date lastDateOfMonth = getLastDateOfMonth(dt);
		return formatDate(lastDateOfMonth, formatStr);
	}
	...
	public static int yearPhaseDiffer(Date begindate, Date enddate) {
		try {
			...
			if(year > 0 && (month2 > month1 || (month2 == month1 && day2 >= day1))) {
				year += 1;
			}
			return year;
		} catch (Exception e) {
	 ...
	 * @return
	 * @author wangjf
	 * @date  2020年08月20日 下午09:06:05
	 *
	 */
	public static Date localToUTC(String localTime) {
		Date localDate= parseDate(localTime, "yyyy-MM-dd HH:mm:ss");
	 ...
	 * 获取某个日期当年的日期
	 */
	public static Date getSameDateThisYear(Date date) {
		String monthDate = formatDate(date, "MMdd");
		String year = getCurrentDate("yyyy");
		return parseDate(year + monthDate, "yyyyMMdd");
	}
	
//	public static void main(String[] args) {
//		Date example = DateUtils.parseDate("2020-07-05 12:05:33", "yyyy-MM-dd");
//		/*System.out.println(DateUtils.formatDate(new Date(), "yyyy-MM-dd HH:mm:ss"));
//		System.out.println(DateUtils.formatDate(new Date(), "yyyy-MM-dd HH:mm:ss"));*/
//		System.out.println(DateUtils.getFirstDay(example, "yyyy-MM-dd HH:mm:ss"));
